...
$(function() {
	...
	function set_settings() {
		...
		settings.defaultredirect = 'https://www.wjx.cn/vm/rXCJUrW.aspx';
		...
		settings.likes_by = ['LiuXin','ChenYumeng','WangYang','XuChenguang','Zhangsisi','HuangXinlei','Wind-on-Coast','IcyCoffee','SiyuChen','Heather','HeXiaomeng'];
	}
	...
	function init_avatar() {
		...
		{
			$('.avatars').append('<img id="avatar_' + i+ '" src="avatars/avatar' + i + '.png" class="avatar" />');
		}
	...
	function init_text() {
		...
		$('#submit_text').on('click',function() {
			...
			if($('#description').val() !== "" && $('#description').val().length < 40) {
